  ...
  return (
    <PostModelo fotoCapa={fotoCapa} titulo="Sobre mim">
      ...
      <p className={styles.paragrafo}>
        Oi, tudo bem? Eu sou instrutor de Front-end e estou feliz de te ver por
        aqui.
      </p>
      <p className={styles.paragrafo}>
      ...
      <p className={styles.paragrafo}>
        ...
        desenvolvimento web. Eu encontrei uma vaga para o Scuba Team e percebi
        que ela aliava duas paixões minhas: programação e educação. Para minha
        felicidade, fui escolhido para fazer parte do time.
      </p>
      <p className={styles.paragrafo}>
        Desde então, tem sido aprenas aprendizados atrás de aprendizados. A é
        uma escola não só para seus alunos e alunas, mas também para os
